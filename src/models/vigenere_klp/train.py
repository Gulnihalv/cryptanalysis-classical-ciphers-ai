...
from klp_data_module import VigenereDataModule
...
def main():
    ...
    checkpoint_callback = ModelCheckpoint(
        dirpath="checkpoints_length_predictor",
    ...
    logger = TensorBoardLogger("tb_logs", name="length_predictor2")
